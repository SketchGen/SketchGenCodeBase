...
public class TestTranslator {
  ...
  public static String translate(String testPath, int testNum)
      throws UnsupportedHoleException, AlloySyntaxErrorException, TestValuationUnsatisfiableException {
    String modelText = TextFileReader.readText(testPath);
    ...
    logger.info("Number of Test: " + cnt);
  ...
  private static String convertA4SolutionToTestFact(A4Solution valuation, String testPredName,
    ...
    String restArgs = String.join(", ", sigsAndFields.stream().map(relation -> (
        relation.getTypes().size() == 1 && relation.getValue().equals(relation.getTypes().get(0)) ?
